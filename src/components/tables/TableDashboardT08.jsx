...
import { handleGetExecKpiExcel } from "../../lib/api";
import * as XLSX from "xlsx";
import { saveAs } from "file-saver";
const TableDashboardT08 = forwardRef((props, ref) => {
  ...
  const [PLAN_DTHU_GPS_KGM, SET_PLAN_DTHU_GPS_KGM] = useState({});
  ...
  const [PLAN_SL_HD_GPS_KHDN, SET_PLAN_SL_HD_GPS_KHDN] = useState({});
  // kpi thuc hien
  // //////////////////////////////////////////////////////////////
  ...
  const handleCaculateKpiKHO = () => {
    if (!loadingExec && !loadingPlan) {
      ...
      kpiData.forEach((object, index) => {
        ...
        if (object.nameKpi == "DTHU_GPS_KGM") {
          const uocTh = parseFloat(
            ((EXEC_DTHU_GPS_KGM.KHO /
              (new Date(
                selectedDate.getFullYear(),
                selectedDate.getMonth() + 1,
                0
              ) < new Date(EXEC_DTHU_GPS_KGM.LAST_DATE)
                ? sumDateInMonth
                : new Date(EXEC_DTHU_GPS_KGM.LAST_DATE).getDate())) *
              sumDateInMonth *
              100) /
              (PLAN_DTHU_GPS_KGM.KHO * 1000000)
          );
          const kpiDthuGps =
            PLAN_DTHU_GPS_KGM.KHO == 0
              ? (object.point * object.maxPercent) / 100
              : uocTh > 120
              ? (object.point * object.maxPercent) / 100
              : (uocTh / 100) * object.point;
        ...
        if (object.nameKpi == "SL_HD_GPS_KHDN") {
          const uocTh = parseFloat(
            (EXEC_SL_HD_GPS_KHDN.KHO * 100) / PLAN_SL_HD_GPS_KHDN.KHO
          );
        ...
        <tbody className={` ${isSticky && "is-sticky"}`}>
          ...
          <tr>
            ...
            <td className="cell-number">
              {loadingExec ? (
                ...
                convertToFloat2Fixed(
                  EXEC_DTHU_TKC_HTS.KHO / 1000000 +
                    (EXEC_DTHU_FIBER.KHO ? EXEC_DTHU_FIBER.KHO / 1000000 : 0)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec ? (
                ...
                convertToFloat2Fixed(
                  EXEC_DTHU_TKC_HTS.DLA / 1000000 +
                    (EXEC_DTHU_FIBER.DLA ? EXEC_DTHU_FIBER.DLA / 1000000 : 0)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec ? (
                ...
                convertToFloat2Fixed(
                  EXEC_DTHU_TKC_HTS.GLA / 1000000 +
                    +(EXEC_DTHU_FIBER.GLA ? EXEC_DTHU_FIBER.GLA / 1000000 : 0)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec ? (
                ...
                convertToFloat2Fixed(
                  EXEC_DTHU_TKC_HTS.PYE / 1000000 +
                    +(EXEC_DTHU_FIBER.PYE ? EXEC_DTHU_FIBER.PYE / 1000000 : 0)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec ? (
                ...
                convertToFloat2Fixed(
                  EXEC_DTHU_TKC_HTS.DNO / 1000000 +
                    +(EXEC_DTHU_FIBER.DNO ? EXEC_DTHU_FIBER.DNO / 1000000 : 0)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec ? (
                ...
                convertToFloat2Fixed(
                  EXEC_DTHU_TKC_HTS.KON / 1000000 +
                    +(EXEC_DTHU_FIBER.KON ? EXEC_DTHU_FIBER.KON / 1000000 : 0)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec ? (
                ...
                convertToFloat2Fixed(
                  EXEC_DTHU_TKC_HTS.CTY7 / 1000000 +
                    (EXEC_DTHU_FIBER.CTY7 ? EXEC_DTHU_FIBER.CTY7 / 1000000 : 0)
                )
              ) : (
                ""
              )}
          ...
          <tr>
            ...
            <td className="cell-number">
              {loadingPlan ? (
                <LoadingComponent />
              ) : PLAN_DTHU_GPS_KGM.KHO ? (
                convertToFloat2Fixed(PLAN_DTHU_GPS_KGM.KHO)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingPlan ? (
                <LoadingComponent />
              ) : PLAN_DTHU_GPS_KGM.DLA ? (
                convertToFloat2Fixed(PLAN_DTHU_GPS_KGM.DLA)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingPlan ? (
                <LoadingComponent />
              ) : PLAN_DTHU_GPS_KGM.GLA ? (
                convertToFloat2Fixed(PLAN_DTHU_GPS_KGM.GLA)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingPlan ? (
                <LoadingComponent />
              ) : PLAN_DTHU_GPS_KGM.PYE ? (
                convertToFloat2Fixed(PLAN_DTHU_GPS_KGM.PYE)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingPlan ? (
                <LoadingComponent />
              ) : PLAN_DTHU_GPS_KGM.DNO ? (
                convertToFloat2Fixed(PLAN_DTHU_GPS_KGM.DNO)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingPlan ? (
                <LoadingComponent />
              ) : PLAN_DTHU_GPS_KGM.KON ? (
                convertToFloat2Fixed(PLAN_DTHU_GPS_KGM.KON)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingPlan ? (
                <LoadingComponent />
              ) : PLAN_DTHU_GPS_KGM.CTY7 ? (
                convertToFloat2Fixed(PLAN_DTHU_GPS_KGM.CTY7)
              ) : (
                ""
              )}
            </td>
            <td rowSpan={4} className="cell-donviphutrach">
              ...
              <br />
              <span>
                {EXEC_DTHU_GPS_KGM.LAST_DATE
                  ? getFormattedDate(new Date(EXEC_DTHU_GPS_KGM.LAST_DATE))
                  : ""}
              </span>
            </td>
          </tr>
          <tr>
            ...
            <td className="cell-number">
              {loadingExec ? (
                ...
                convertToFloat2Fixed(EXEC_DTHU_GPS_KGM.KHO / 1000000)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.DLA ? (
                convertToFloat2Fixed(EXEC_DTHU_GPS_KGM.DLA / 1000000)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.GLA ? (
                convertToFloat2Fixed(EXEC_DTHU_GPS_KGM.GLA / 1000000)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.PYE ? (
                convertToFloat2Fixed(EXEC_DTHU_GPS_KGM.PYE / 1000000)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.DNO ? (
                convertToFloat2Fixed(EXEC_DTHU_GPS_KGM.DNO / 1000000)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.KON ? (
                convertToFloat2Fixed(EXEC_DTHU_GPS_KGM.KON / 1000000)
              ) : (
                ""
              )}
            </td>
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.CTY7 ? (
                convertToFloat2Fixed(EXEC_DTHU_GPS_KGM.CTY7 / 1000000)
              ) : (
                ""
              )}
            </td>
          ...
          <tr>
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.KHO && PLAN_DTHU_GPS_KGM.KHO ? (
                convertToFloat2Fixed(
                  (EXEC_DTHU_GPS_KGM.KHO * 100) /
                    (PLAN_DTHU_GPS_KGM.KHO * 1000000)
                )
              ) : (
                ""
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.DLA && PLAN_DTHU_GPS_KGM.DLA ? (
                convertToFloat2Fixed(
                  (EXEC_DTHU_GPS_KGM.DLA * 100) /
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.GLA && PLAN_DTHU_GPS_KGM.GLA ? (
                convertToFloat2Fixed(
                  (EXEC_DTHU_GPS_KGM.GLA * 100) /
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.PYE && PLAN_DTHU_GPS_KGM.PYE ? (
                convertToFloat2Fixed(
                  (EXEC_DTHU_GPS_KGM.PYE * 100) /
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.DNO && PLAN_DTHU_GPS_KGM.DNO ? (
                convertToFloat2Fixed(
                  (EXEC_DTHU_GPS_KGM.DNO * 100) /
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.KON && PLAN_DTHU_GPS_KGM.KON ? (
                convertToFloat2Fixed(
                  (EXEC_DTHU_GPS_KGM.KON * 100) /
          ...
          <tr>
            ...
            >
              {loadingExec || loadingPlan ? (
                <LoadingComponent />
              ) : EXEC_DTHU_GPS_KGM.GLA && PLAN_DTHU_GPS_KGM.KHO ? (
                convertToFloat2Fixed(
                  ((EXEC_DTHU_GPS_KGM.GLA /
                    (new Date(
                      selectedDate.getFullYear(),
          ...
          <tr>
            ...
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_TB_PTM_FIBER.KHO != null ||
                EXEC_TB_PTM_FIBER.KHO != undefined ? (
            ...
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_TB_PTM_FIBER.DLA != null ||
                EXEC_TB_PTM_FIBER.DLA != undefined ? (
            ...
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_TB_PTM_FIBER.GLA != null ||
                EXEC_TB_PTM_FIBER.GLA != undefined ? (
            ...
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_TB_PTM_FIBER.PYE != null ||
                EXEC_TB_PTM_FIBER.PYE != undefined ? (
            ...
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_TB_PTM_FIBER.DNO != null ||
                EXEC_TB_PTM_FIBER.DNO != undefined ? (
            ...
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_TB_PTM_FIBER.KON != null ||
                EXEC_TB_PTM_FIBER.KON != undefined ? (
            ...
            <td className="cell-number">
              {loadingExec ? (
                <LoadingComponent />
              ) : EXEC_TB_PTM_FIBER.CTY7 != null ||
                EXEC_TB_PTM_FIBER.CTY7 != undefined ? (
            ...
            <td rowSpan={4} className="cell-donviphutrach">
              ...
              <span>
                {EXEC_SL_HD_GPS_KHDN.LAST_DATE
                  ? getFormattedDate(new Date(EXEC_SL_HD_GPS_KHDN.LAST_DATE))
                  : ""}
              </span>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_SL_HD_GPS_KHDN.DLA * 100) / PLAN_SL_HD_GPS_KHDN.DLA
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_SL_HD_GPS_KHDN.GLA * 100) / PLAN_SL_HD_GPS_KHDN.GLA
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_SL_HD_GPS_KHDN.PYE * 100) / PLAN_SL_HD_GPS_KHDN.PYE
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_SL_HD_GPS_KHDN.DNO * 100) / PLAN_SL_HD_GPS_KHDN.DNO
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_SL_HD_GPS_KHDN.KON * 100) / PLAN_SL_HD_GPS_KHDN.KON
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_SL_HD_GPS_KHDN.CTY7 * 100) / PLAN_SL_HD_GPS_KHDN.CTY7
                )
              ) : (
                ""
              )}
...
export default TableDashboardT08;
