...
const TableDashboardT032026 = forwardRef((props, ref) => {
  ...
  const [PLAN_SL_TB_PTM_M2M_FWAP, SET_PLAN_SL_TB_PTM_M2M_FWAP] = useState({});
  ...
  const [EXEC_SL_TB_PTM_M2M_FWAP, SET_EXEC_SL_TB_PTM_M2M_FWAP] = useState({});
  ...
  const [processKPI, setProsessKpi] = useState(
    convertToNumber(
      new Date(props.selectedDate).getDate() / props.sumDateInMonth
    ) * 100
  );
  ...
  useEffect(() => {
    if (planData.result && planData.result?.length > 0) {
      ...
      planData.result.forEach((object, index) => {
        ...
        if (object["TEN_CHI_TIEU"] == "SL_TB_PTM_M2M_FWAP") {
          SET_PLAN_SL_TB_PTM_M2M_FWAP(object);
        }
  ...
  useEffect(() => {
    if (execData && execData.result?.length > 0) {
      execData.result.forEach((object, index) => {
        ...
        if (object["TEN_CHI_TIEU"] == "SL_TB_PTM_M2M_FWAP") {
          SET_EXEC_SL_TB_PTM_M2M_FWAP(object);
        }
        if (object["TEN_CHI_TIEU"] == "TB_PTM_SAYMEE") {
          ...
          <tbody className={`table-body`}>
            ...
            <tr>
              ...
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T01 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T01)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T02 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T02)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T03 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T03)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T04 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T04)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T05 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T05)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T06 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T06)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T07 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T07)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T08 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T08)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T09 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T09)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T10 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T10)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T11 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T11)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T12 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T12)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_T13 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T13)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_D01 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D01)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_D02 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D02)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_D03 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D03)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_D04 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D04)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_D05 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D05)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.DLA_D06 ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D06)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.TTKDVT ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.TTKDVT)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : PLAN_SL_TB_PTM_M2M_FWAP.TTKDGPS ? (
                  convertToFloat2Fixed(PLAN_SL_TB_PTM_M2M_FWAP.TTKDGPS)
                ) : (
                  ""
                )}
              </td>
              <td rowSpan={3}>
                {EXEC_SL_TB_PTM_M2M_FWAP.LAST_DATE
                  ? getFormattedDate(new Date(EXEC_SL_TB_PTM_M2M_FWAP.LAST_DATE))
                  : ""}
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T01 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T01)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T02 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T02)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T03 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T03)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T04 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T04)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T05 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T05)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T06 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T06)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T07 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T07)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T08 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T08)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T09 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T09)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T10 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T10)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T11 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T11)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T12 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T12)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T13 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T13)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D01 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D01)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D02 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D02)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D03 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D03)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D04 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D04)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D05 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D05)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D06 ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D06)
                ) : (
                  ""
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  ...
                  convertToFloat2Fixed(
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T01) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T02) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T03) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T04) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T05) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T06) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T07) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T08) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T09) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T10) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T11) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T12) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T13) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D01) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D02) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D03) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D04) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D05) +
                    convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D06)
                  )
                )}
              </td>
              <td>
                ...
                {loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.TTKDGPS ? (
                  convertToFloat2Fixed(EXEC_SL_TB_PTM_M2M_FWAP.TTKDGPS)
                ) : (
                  ""
                )}
              </td>
            ...
            <tr>
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T01) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T01) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T01 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T01 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T01 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T01
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T02) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T02) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T02 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T02 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T02 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T02
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T03) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T03) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T03 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T03 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T03 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T03
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T04) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T04) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T04 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T04 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T04 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T04
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T05) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T05) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T05 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T05 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T05 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T05
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T06) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T06) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T06 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T06 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T06 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T06
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T07) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T07) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T07 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T07 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T07 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T07
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T08) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T08) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T08 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T08 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T08 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T08
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T09) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T09) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T09 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T09 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T09 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T09
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T10) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T10) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T10 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T10 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T10 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T10
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T11) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T11) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T11 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T11 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T11 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T11
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T12) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T12) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T12 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T12 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T12 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T12
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T13) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_T13) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_T13 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_T13 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_T13 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_T13
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D01) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D01) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D01 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_D01 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_D01 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_D01
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D02) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D02) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D02 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_D02 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_D02 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_D02
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D03) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D03) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D03 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_D03 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_D03 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_D03
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D04) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D04) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D04 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_D04 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_D04 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_D04
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D05) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D05) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D05 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_D05 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_D05 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_D05
                  ) + "%"
                ) : (
                  ""
              ...
              <td
                className={
                  (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D06) * 100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.DLA_D06) >
                    processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.DLA_D06 && PLAN_SL_TB_PTM_M2M_FWAP.DLA_D06 ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.DLA_D06 * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.DLA_D06
                  ) + "%"
                ) : (
                  ""
                ...
                className={
                  convertToFloat2Fixed(
                    ((convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_T01) +
                      ...
                      convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.DLA_D06)) *
                      100) /
                    convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.TTKDVT)
                  ) > processKPI
                    ? "bg-green"
                    : "bg-red"
                }
              ...
              <td
              // className={
              //   (convertToNumber(EXEC_SL_TB_PTM_M2M_FWAP.TTKDGPS) * 100) /
              //     convertToNumberMauso(PLAN_SL_TB_PTM_M2M_FWAP.TTKDGPS) >
              //   processKPI
              //     ? "bg-green"
              //     : "bg-red"
              // }
              >
                {loadingExec || loadingPlan ? (
                  <LoadingComponent />
                ) : EXEC_SL_TB_PTM_M2M_FWAP.TTKDGPS && PLAN_SL_TB_PTM_M2M_FWAP.TTKDGPS ? (
                  convertToFloat2Fixed(
                    (EXEC_SL_TB_PTM_M2M_FWAP.TTKDGPS * 100) /
                    PLAN_SL_TB_PTM_M2M_FWAP.TTKDGPS
                  ) + "%"
                ) : (
                  ""
...
export default TableDashboardT032026;
