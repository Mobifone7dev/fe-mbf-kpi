    ...
    if (!loadingExec && !loadingPlan) {
      ...
      kpiData.forEach((object, index) => {
        ...
        if (object.nameKpi == "DTHU_FIBER") {
          const uocTh = parseFloat(
            ((EXEC_DTHU_FIBER.KHO /
              (new Date(selectedDate.getFullYear(), selectedDate.getMonth() + 1, 0) < new Date(EXEC_DTHU_FIBER.LAST_DATE)
                ? sumDateInMonth
          ...
          <tr>
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_DTHU_FIBER.KHO * 100) / (PLAN_DTHU_FIBER.KHO * 1000000)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_DTHU_FIBER.DLA * 100) / (PLAN_DTHU_FIBER.DLA * 1000000)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_DTHU_FIBER.GLA * 100) / (PLAN_DTHU_FIBER.GLA * 1000000)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_DTHU_FIBER.PYE * 100) / (PLAN_DTHU_FIBER.PYE * 1000000)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_DTHU_FIBER.DNO * 100) / (PLAN_DTHU_FIBER.DNO * 1000000)
                )
              ) : (
                ""
              )}
            ...
            <td className="cell-number">
              {loadingExec || loadingPlan ? (
                ...
                convertToFloat2Fixed(
                  (EXEC_DTHU_FIBER.KON * 100) / (PLAN_DTHU_FIBER.KON * 1000000)
                )
              ) : (
                ""
              )}
...
export default TableDashboardT03;
